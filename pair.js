...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://oshadhaoshadha12345_db_user:SH0m8ksHl8A0ZfBF@oshiya.bc9b5e4.mongodb.net/?appName=Oshiya'; //we need to create a mongodb url soon
